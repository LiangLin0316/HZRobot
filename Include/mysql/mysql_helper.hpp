...
typedef my_bool(STDCALL *mysql_ssl_set_t)(MYSQL *mysql, const char *key, const char *cert, const char *ca,
...
typedef MYSQL *(STDCALL *mysql_real_connect_t)(MYSQL *mysql, const char *host, const char *user, const char *passwd,
...
typedef unsigned long (STDCALL *mysql_real_escape_string_t)(MYSQL *mysql, char *to, const char *from,
...
typedef int (STDCALL *mysql_stmt_fetch_column_t)(MYSQL_STMT *stmt, MYSQL_BIND *bind_arg, unsigned int column,
...
typedef my_bool(STDCALL *mysql_stmt_send_long_data_t)(MYSQL_STMT *stmt, unsigned int param_number, const char *data,
                                                      unsigned long length);
