...
#define http_content_jscript "application/javascript"
...
namespace shine
{
    namespace http
    {
        ...
        private:
			...
			SHINE_GEN_MEMBER_GETSET(string, content_type);
        ...
        public:
            ...
            bool encode(string &buf) const
            {
				...
				if(get_content_type().size()!=0)
					buf += "Content-Type: "+get_content_type()+"\r\n";
				buf += "Accept: */* \r\n";
				buf += "Host: " + get_host() + "\r\n";
